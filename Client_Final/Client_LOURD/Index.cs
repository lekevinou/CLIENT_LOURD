...
<<<<<<< HEAD
        private void btn_ajoutRes_Click(object sender, EventArgs e)
        {
            ajoutReservation AjouterReservation = new ajoutReservation();
            AjouterReservation.Show(); // ouvre la fenêtre ajoutReservation.cs
        }
