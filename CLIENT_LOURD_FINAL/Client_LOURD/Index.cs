...
namespace Client_LOURD
{
    public partial class Index : Form
    {
        ...
        {
            // Ouverture de la fenêtre gestion des client
        ...
        private void gestion_personnel_Click(object sender, EventArgs e)
        {
            gestionPersonnel gestionPersonnel = new gestionPersonnel();
            gestionPersonnel.Show(); 
        }

        private void btn_ajout_res_Click(object sender, EventArgs e)
        {
            ajoutReservation ajoutReservation = new ajoutReservation();
            ajoutReservation.Show(); 
        }
    }
}
