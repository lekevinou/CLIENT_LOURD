...
namespace MaBibliotheque
{
    ...
    public class clientManager
    {
        ...
        {
            this.maConnection.Open();
            string req = "INSERT INTO CLIENT VALUES('" + unClient.Nom.Replace("'", "''") + "','" + unClient.Prenom.Replace("'", "''") + "','" + unClient.Adresse1.Replace("'", "''") + "','" + unClient.Ville_client.Replace("'", "''") + "','" + unClient.Cp_client.Replace("'", "''") + "','" + unClient.Adresse2.Replace("'", "''") + "','" + unClient.Tel.Replace("'", "''") + "','" + unClient.Mail.Replace("'", "''") + "')";
            SqlCommand cmd = new SqlCommand(req, maConnection);
            SqlDataReader reader = cmd.ExecuteReader();
            this.maConnection.Close();
        }
        ...
        {
            this.maConnection.Open();
            string req = "UPDATE CLIENT SET nom_client ='"+unClient.Nom.Replace("'", "''")+"', prenom_client = '"+unClient.Prenom.Replace("'", "''")+"', adr_client_l1 = '"+unClient.Adresse1.Replace("'", "''")+"', ville_client = '"+unClient.Ville_client.Replace("'", "''")+"', cp_client = '"+unClient.Cp_client.Replace("'", "''")+"', adr_client_l2 = '"+unClient.Adresse2.Replace("'", "''")+"', tel_client = '"+unClient.Tel.Replace("'", "''")+"', mail_client = '"+unClient.Mail.Replace("'", "''")+"' WHERE id_client = '"+unClient.Id+"'";
            SqlCommand cmd = new SqlCommand(req, maConnection);
            SqlDataReader reader = cmd.ExecuteReader();
            this.maConnection.Close();
        }
